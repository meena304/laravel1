    ...
    <!-- Main content -->
        ...
        <div class="card">
          ...
          include "dbconn.php";
            ...
            $data ="SELECT * FROM `sourcing_partner` order by sp_name ASC";
          ...
          ?>
                ...
                <tr>
                  <td class="id"><?php echo $a['sp_name'] ?></td>
                  <td><?php echo $a['sp_city'] ?></td>

                  <td >
                    <a href="tel:+<?php echo $a['sp_phone'] ?>">
                      +<?php echo $a['sp_phone'] ?>
                    </a>
                  </td>
                 <td >
                    <a href="tel:+<?php echo $a['sp_phone_alt'] ?>">
                      +<?php echo $a['sp_phone_alt'] ?>
                    </a>
                  </td>
                  <td>
                    <a target="_blank" href="https://wa.me/<?php echo $a['sp_whatsapp'] ?>?text=Hello%20I%20want%20to%20know%20about%20VilloTale">
                      +<?php echo $a['sp_whatsapp'] ?>
                        
                    </a>
                  </td>

                  <td >
                    <a href="mailto:<?php echo $a['sp_email'] ?>">
                      <?php echo $a['sp_email'] ?>
                    </a>
                  </td>
