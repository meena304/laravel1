    ...
    <!-- Main content -->
        ...
        <div class="card">
          ...
          include "dbconn.php";
            ...
            $data ="SELECT property_master.id,property_master.prop_id, property_master.property_name, property_type.proptype, property_master.property_owner, property_master.prop_contact_no, property_master.prop_whatsapp, property_master.prop_phone_alt, property_master.prop_owner_email, sourcing_partner.sp_entity_name,property_master.prop_stat FROM (property_master INNER JOIN property_type ON property_master.property_type = property_type.proptype_id) LEFT JOIN sourcing_partner ON property_master.prop_sourcing_partner = sourcing_partner.sp_id";
          ...
          ?>
                ...
                <tr>
                  <td class="id"><?php echo $a['prop_id'] ?></td>
                  <td><?php echo $a['property_name'] ?></td>
