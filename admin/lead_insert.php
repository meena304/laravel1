<?php
    ...
    if(isset($_POST['ADD']))
    {
      ...
      $data = "SELECT * FROM package_details WHERE package_id='$f'";
      ...
      $nn = $z['telecaller_name'];
    	...
    	$data = "INSERT INTO lead_master(guest_name, guest_ph, guest_alt_ph, guest_whatsapp, guest_email, package_id, no_of_traveler, expected_travel_date, lead_date, lead_source, lead_telecaller, lead_type, lead_status,guest_city,t_id,pkg_det_id)VALUES('$a','$b','$c','$d','$e','$f','$g','$h','$i','$j','$nn','$l','$m','$n','$o','$x')";
    	$result = mysqli_query($con,$data);
    ...
    if(isset($_POST['c_view']))
    {
        ...
        $result = mysqli_query($con,$data);
         while ($a = mysqli_fetch_array($result))
          {
            $pk_id = $a['package_id'];
            $data = "SELECT * FROM package_master WHERE package_id = '$pk_id' ";
            $result = mysqli_query($con,$data);
            ...
            <h6><b>Interested in : </b>'.$b['package_name'].'</h6>
  ...
  $data = "UPDATE lead_master SET guest_name = '$a', guest_ph = '$b', guest_alt_ph = '$c', guest_whatsapp = '$d', guest_email = '$e', package_id = '$f', no_of_traveler = '$g', expected_travel_date = '$h', lead_date = '$i', lead_source = '$j', lead_telecaller = '$k', lead_type = '$l', lead_status = '$m'  WHERE lead_id = '$id' ";
  $result = mysqli_query($con, $data);
