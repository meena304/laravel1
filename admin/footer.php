...
<script>
  $(document).ready(function() {
    ...
    $("#example1").on("click", ".pt_btn", function(e){
    // $('.ls_btn').click(function(e){
      e.preventDefault();
       ...
       $.ajax({
        ...
        success: function(response) {
          ...
          $.each(response, function(key,value){
            ...
            $('#pt_id').val(value['pkgtype_id']);
            $('#pt_name').val(value['pkgtype']);
            $('#pt_status').val(value['pkgtype_status']);
