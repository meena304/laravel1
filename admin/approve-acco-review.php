    ...
    <!-- Main content -->
        ...
        <div class="card">
          ...
          include "dbconn.php";
            ...
            $data = "SELECT property_master.property_name, booking_master.guest_name, feedback.stay, feedback.cleanliness, feedback.food, feedback.myhost, feedback.hospitality, feedback.stay_again, feedback.refer_to_friends, feedback.testimonial, feedback.feedback, property_master.id, feedback.status
FROM (feedback INNER JOIN property_master ON feedback.prop_id = property_master.id) INNER JOIN booking_master ON feedback.booking_id = booking_master.b_id
WHERE (((feedback.status)=1))
GROUP BY property_master.property_name, booking_master.guest_name, feedback.stay, feedback.cleanliness, feedback.food, feedback.myhost, feedback.hospitality, feedback.stay_again, feedback.refer_to_friends, feedback.testimonial, feedback.feedback, property_master.id, feedback.status";
          ...
          ?>
                ...
                <tr>
                  <td class="id"><?php echo $a['property_name'] ?></td>
                  <td><?php echo $a['guest_name'] ?></td>
                  <td><?php echo $a['stay'] ?></td>
                  <td>
      ...
      <div class="modal-header">
        ...
        <form method="post" name="frm_add_acco" action="tele_insert.php">
          ...
          <div class="form-group">
            ...
            <input name="txt_acco_name" type="text" class="txtbox" id="txt_acco_name" required />
          </div>
          ...
          <div class="form-group">
            ...
            <input type="number" name="telecaller_alt_phone" required class="form-control">
          </div>
