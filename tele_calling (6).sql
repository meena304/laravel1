...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 28, 2021 at 04:21 PM
...
(19, 45, 'Ankit', 'aass@gmail.com', 'aass@gmail.com', 'caller');
...
--
-- Dumping data for table `package_supplier_master`
--

INSERT INTO `package_supplier_master` (`pkg_vendor_id`, `supplier_name`, `supplier_type`, `supplier_contact_name`, `supplier_contact_number`, `supplier_email`, `supplier_address`, `supplier_state`, `supplier_gst`) VALUES
(1, 'tyth', 'Hotel', 'gtgh', '08427764988', 'mku304@gmail.com', 'house no.339,APS,bank colony,badagao,morar cantt', 'Madhya Pradesh', '56');
...
--
-- Dumping data for table `tele_caller`
--

INSERT INTO `tele_caller` (`t_id`, `auth_user`, `auth_time`, `auth_ip`, `telecaller_name`, `telecaller_phone`, `telecaller_alt_phone`, `telecaller_whatsapp`, `telecaller_email`, `commission_per_call`, `commission_type`, `basic_pay`, `telecaller_status`) VALUES
(45, 0, '2021-03-27 08:58:07', '', 'Ankit', '245456', '53467', '53647', 'aass@gmail.com', '65', 'Percentage', '65', 'active');
...
--
ALTER TABLE `lead_call_details`
  MODIFY `lead_follow_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=743;

--
-- AUTO_INCREMENT for table `lead_closure`
--
ALTER TABLE `lead_closure`
  MODIFY `lead_closure_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT for table `lead_master`
--
ALTER TABLE `lead_master`
  MODIFY `lead_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1220;
